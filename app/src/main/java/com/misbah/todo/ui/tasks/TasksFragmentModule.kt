...
class TasksFragmentModule {
    ...
    @Provides
    fun provideViewModel(taskDao : TaskDao, preferencesManager: PreferencesManager, state : SavedStateHandle) : TasksViewModel {
        return TasksViewModel(taskDao, preferencesManager, state)
    }
